...
export default function EvalPage() {
  ...
  // Load shows list from localStorage on mount
  useEffect(() => {
  ...
  // Save shows list to localStorage
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="flex flex-col lg:flex-row gap-6 p-6 max-w-7xl mx-auto pt-20">
        ...
        <div className="flex-1 lg:max-w-md space-y-6">
            ...
            {showsList ? (
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button size="sm" variant="ghost" onClick={handleChangeList}>
                    Change List
                  </Button>
                </div>
              </div>
          ...
          {/* Run button + report links */}
          <div className="space-y-2">
            <Button
              onClick={handleRunEval}
              disabled={!showsList?.trim() || status === 'loading'}
              className="w-full"
            >
            ...
            <div className="flex gap-2">
              ...
              <a
                href="/eval-reports/index.html"
                target="_blank"
                rel="noopener noreferrer"
                className={evalResult?.reportUrl ? '' : 'flex-1'}
              >
                <Button variant="outline" size="sm" className="w-full text-xs">
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-end gap-4">
                    <div
                      className={`${GRADE_COLORS[evalResult.grade]} ${GRADE_TEXT_SIZES[evalResult.grade]} font-bold rounded-lg px-4 py-2`}
                    >
                      {evalResult.grade}
                    </div>
                    <div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm">
                    Recommendations Generated ({evalResult.recommendations.length})
                  </CardTitle>
                </CardHeader>
                <CardContent>
