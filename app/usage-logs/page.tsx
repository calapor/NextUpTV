...
export default function UsageLogsPage() {
  ...
  return (
    <div className="min-h-screen bg-background p-6 pt-20 max-w-7xl mx-auto">
                ...
                {entries.map((entry, i) => (
                  <>
                    ...
                    >
                      ...
                      <td className="px-4 py-2.5 text-xs tabular-nums text-muted-foreground" title={entry.inputTokens != null ? `${entry.inputTokens.toLocaleString()} in · ${entry.outputTokens?.toLocaleString()} out` : undefined}>
