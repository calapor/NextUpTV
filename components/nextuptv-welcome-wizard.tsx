...
import { WelcomeWizard, type WizardSlide } from './welcome-wizard';
...
export function NextUpTVWelcomeWizard() {
  return <WelcomeWizard slides={slides} sessionKey="nextuptv_welcome_seen" />;
}
