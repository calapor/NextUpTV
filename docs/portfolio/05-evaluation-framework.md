...
![Eval workbench — B grade result with per-criterion breakdown](assets/screenshots/eval-workbench-b-grade.png)
...
![Eval report — HTML output with grade card and recommendations table](assets/screenshots/eval-report-html.png)
